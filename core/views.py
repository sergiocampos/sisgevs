...
def export_data_csv(request):
	...
	writer.writerow([
		...
		'ponto_referencia_residencia','telefone_residencia','zona_residencia','pais_residencia','data_investigacao',	ocupacao	ambientes_frequentados	animais_que_teve_contato	natureza_contato_animais	relacao_animal_doente	exerce_atividade_contato_plantas	historico_contato_material	presenca_lesao_pele	natureza_lesao	natureza_lesao_outro	local_lesao	local_lesao_outro	diagnostico_forma_extrac_doenca	localizacao_forma_extrac_doenca	houve_coleta_material	data_coleta1	numero_gal1	data_coleta2	numero_gal2	data_coleta3	numero_gal3	resultado_isolamento	agente	histopatologia	data_resultado_exame1	descricao_exame_1	resultado_exame1	data_resultado_exame2	descricao_exame_2	resultado_exame2	data_resultado_exame3	descricao_exame_3	resultado_exame3	data_inicio_tratamento1	droga_administrada1	esquema_terapeutico1	data_inicio_tratamento2	droga_administrada2	esquema_terapeutico2	data_inicio_tratamento3	droga_administrada3	esquema_terapeutico3	hospitalizacao	data_internacao	data_da_alta	uf_hospitalizacao	municipio_hospitalizacao	codigo_ibge_hospitalizacao	nome_hospital_hospitalizacao	classificacao_final	criterio_confirmacao	caso_autoctone_municipio_residencia	uf_caso_autoctone	pais_caso_autoctone	municipio_caso_autoctone	codigo_ibge_caso_autoctone	distrito_caso_autoctone	bairro_caso_autoctone	area_provavel_infeccao_caso_autoctone	ambiente_infeccao_caso_autoctone	doenca_rel_trabalho_caso_autoctone	evolucao_caso	data_obito	data_encerramento	observacao	nome_investigador	funcao_investigador	email_investigador	telefone_investigador	conselho_classe_investigador	numero_unico	gerencia_id	responsavel_pelas_informacoes_id
